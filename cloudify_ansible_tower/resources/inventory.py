...
"""
    resources.Inventory
    ~~~~~~~~~~~~~~~~~~~
    Ansible Tower Inventory interface
"""
...
def create(**_):
    """Uses an existing, or creates a new, Inventory"""
    ...
    ctx.instance.runtime_properties['resource'] = \
        utils.task_resource_create(Inventory(), config)
...
def delete(**_):
    """Deletes a Inventory"""
    utils.task_resource_delete(Inventory())
